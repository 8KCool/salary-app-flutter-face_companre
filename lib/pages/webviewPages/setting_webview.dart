...
class SettingWebViewPage extends StatefulWidget {
  const SettingWebViewPage({Key? key}) : super(key: key);

  @override
  State<SettingWebViewPage> createState() => _SettingWebViewPageState();
}

class _SettingWebViewPageState extends State<SettingWebViewPage> {
  ...
  void initState() {
    ...
    globalSettingController =  controller
  ...
  getCookies(msg)async{
    var cookies = await globalSettingController.runJavaScriptReturningResult(
      'document.cookie',
    );
    print("${msg}----${cookies}");
  }
