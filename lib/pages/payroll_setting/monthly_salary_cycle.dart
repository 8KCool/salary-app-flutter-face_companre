...
class MonthlySalaryCycle extends StatefulWidget {
  const MonthlySalaryCycle({Key? key}) : super(key: key);

  @override
  State<MonthlySalaryCycle> createState() => _MonthlySalaryCycleState();
}
enum SingingCharacter { lafayette, jefferson }
class _MonthlySalaryCycleState extends State<MonthlySalaryCycle> {
  SingingCharacter? _character = SingingCharacter.lafayette;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBar(context: context, title: 'Monthly Salary Cycle', titlecenter: false),
        ...
        child: Stack(
          children: [
            ...
            Column(
              ...
              children: [
                MainHeadingText(text: 'Monthly Salary Cycle', fontSize: 16,),
                vSizedBox2,
                GestureDetector(
                  onTap: () {
                    showCustomDialogBox(
                                  ...
                                  ResponsiveGridCol(
                                    ...
                                    child: Center(
                                      child: Container(
                                        ...
                                        child: Center(child: Text('${i+18}', style: TextStyle(fontSize: 14,),)),
                                      ),
                                    ),
                                  ),
                              ],
                  ...
                  child: Container(
                    ...
                    child: Center(child: ParagraphText(text: '21-20', fontSize: 20, color: MyColors.black,))
                  ),
                ),
                vSizedBox2,
                vSizedBox,
