...
class Attendance_Approval_Page extends StatefulWidget {
  const Attendance_Approval_Page({Key? key}) : super(key: key);

  @override
  State<Attendance_Approval_Page> createState() => _Attendance_Approval_PageState();
}

class _Attendance_Approval_PageState extends State<Attendance_Approval_Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar(context: context, title: 'Attendance Approval', titlecenter: false),
                    ...
                    onTapsuffix: (){
                      bottomsheet(
                        ...
                        Column(
                          ...
                          children: [
                            vSizedBox4,
                            MainHeadingText(text: 'Attendance Approval', fontSize: 20, color: MyColors.black,),
                            vSizedBox2,
