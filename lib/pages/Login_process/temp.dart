...
//         .getCalendar(context);
//     for (var i = 0; i < await Provider
//         .of<GlobalModal>(context, listen: false)
//         .calender
//         .length; i++) {
//       selectedDays.add(DateTime.parse(await Provider
//           .of<GlobalModal>(context, listen: false)
//           .calender[i]['holiday_date']));
//       holiDays = { DateTime.parse("2022-10-24 00:00:00.000"),
//         DateTime.parse("2022-10-25 00:00:00.000"),
//         DateTime.parse("2022-10-26 00:00:00.000"),
//         DateTime.parse("2022-10-30 00:00:00.000"),
//         DateTime.parse("2022-11-03 00:00:00.000"),
//         DateTime.parse("2022-11-24 00:00:00.000")};
//
...
//         appBar: appBar(
//             context: context, title: 'Holiday Calander', titlecenter: false),
...
//                               print(
//                                   'date time from calendaer-------------a----' +
//                                       a.toString());
//                               print('date time from calendaer--------b----' +
//                                   b.toString());
//                               Selecteddate =
//                                   DateTime.parse('2022-10-21 00:00:00.000');
//                               // data = [];
//                               // getbooking('1');
//                               setState(() {});
//                             },
...
//                               defaultTextStyle:
//                               TextStyle(fontFamily: 'sf-medium',
//                                   color: Color(0xFE77838F)),
//                               // weekendTextStyle:
...
//                               return holiDays.contains(tempDay);
//                               if (day ==
//                                   DateTime.parse("2022-10-29 00:00:00.000Z")) {
//                                 return true;
//                               }
//                               return false;
//                             },
...
//                               print(
//                                   'selectedDays.contains(a)--------${selectedDays
//                                       .contains(temp)}');
...
//                                             '${globalModal
//                                                 .calender[i]['holiday_date']} 17:08:45'))} , ${ DateFormat
//                                             .E().format(DateTime.parse(
//                                             '${globalModal
//                                                 .calender[i]['holiday_date']} 17:08:45'))}',
