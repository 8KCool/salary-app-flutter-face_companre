...
class MonthlyWiseEmployee extends StatefulWidget {
  const MonthlyWiseEmployee({Key? key}) : super(key: key);

  @override
  State<MonthlyWiseEmployee> createState() => _MonthlyWiseEmployeeState();
}

List bgColor = [Color(0xFEFEF9C3), Color(0xFE2563EB), Color(0xFE16A34A)];
List tag = ['Pending', 'Finalized', 'Processed'];

class _MonthlyWiseEmployeeState extends State<MonthlyWiseEmployee> {
                      ...
                      Row(
                        children: [
                          Expanded(
                            child: Row(
                              children: [
                                MainHeadingText(text: 'July Month', fontSize: 16,),
                                hSizedBox2,
                                Container(
