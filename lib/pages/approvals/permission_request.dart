...
class Permission_Request_Page extends StatefulWidget {
  const Permission_Request_Page({Key? key}) : super(key: key);

  @override
  State<Permission_Request_Page> createState() => _Permission_Request_PageState();
}

class _Permission_Request_PageState extends State<Permission_Request_Page> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: appBar(context: context, title: 'Permission Request', titlecenter: false),
                    ...
                    onTapsuffix: (){
                      bottomsheet(
                        ...
                        Column(
                          ...
                          children: [
                            vSizedBox4,
                            MainHeadingText(text: 'Permission Request', fontSize: 20, color: MyColors.black,),
                            vSizedBox2,
                                          ...
                                          bottomsheet(
                                            ...
                                            height: 430,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  vSizedBox2,
                                                  MainHeadingText(text: 'View Permission Approval', fontSize: 20,),
                                                  vSizedBox,
