...
class _Bank_UPI_PageState extends State<Bank_UPI_Page> {
  ...
  getBankDetail()async{
    ...
    ac_name.text=jsonResponse['data']['account_name'];
    ac_number.text=jsonResponse['data']['account_number'].toString();
    IFSC.text=jsonResponse['data']['ifsc_code'].toString();
    upiId.text=jsonResponse['data']['upi_id'].toString();
    confrim_ac_number.text=jsonResponse['data']['account_number'].toString();
    setState(() {
