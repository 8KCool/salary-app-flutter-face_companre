...
import 'src/customization/calendar_builders.dart';
import 'src/customization/calendar_style.dart';
import 'src/customization/days_of_week_style.dart';
import 'src/customization/header_style.dart';
import 'src/shared/utils.dart';
import 'src/table_calendar_base.dart';
import 'src/widgets/calendar_header.dart';
import 'src/widgets/cell_content.dart';
...
class TableCalendar<T> extends StatefulWidget {
  ...
  final Color? Function(DateTime day)? leaveColor;
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget content = CellContent(
          ...
          leaveColor: widget.leaveColor?.call(day) ?? null,
          // isLeave:
          locale: widget.locale,
        );
